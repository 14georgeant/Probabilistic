...
OPTIMAL ${mode === 'financial' ? 'PORTFOLIO/PATH' : mode === 'health' ? 'TRAINING PROTOCOL' : mode === 'medical' ? 'CLINICAL PATH' : mode === 'programmer' ? 'TECH STACK' : 'STRATEGY PATH'}
---------------------
...
📊 ${mode === 'health' ? 'Performance Probability' : mode === 'medical' ? 'Prognosis Confidence' : mode === 'programmer' ? 'Ship Confidence' : 'Confidence Score'}: ${(result.highestProbability * 100).toFixed(2)}%
        ...
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-gray-700 pb-4 gap-4">
                <h3 className="text-xl font-bold text-white">
                    {mode === 'financial' ? 'Projected Confidence:' : mode === 'health' ? 'Performance Probability:' : mode === 'medical' ? 'Prognosis Confidence:' : mode === 'programmer' ? 'Ship Confidence:' : 'Optimal Path:'} <span className={`text-${theme.main}-400`}>{(result.highestProbability * 100).toFixed(2)}%</span>
                </h3>
            ...
            <div className="bg-gray-800/80 rounded-lg border border-gray-700 p-6">
                <h4 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
                    {mode === 'financial' ? 'Risk Exposure Analysis' : mode === 'health' ? 'Protocol Bottlenecks' : mode === 'medical' ? 'Clinical Contraindications' : mode === 'programmer' ? 'Tech Debt Risks' : 'Leverage Analysis'}
                </h4>
            ...
            {insights && (
                <div className="mt-8">
                    <h3 className="text-xl font-bold text-white mb-3 flex items-center border-t border-gray-700 pt-6">
                        ...
                        Gemini {mode === 'financial' ? 'Advisory' : mode === 'health' ? 'Performance Coach' : mode === 'medical' ? 'Clinical Assessment' : mode === 'programmer' ? 'Code Architecture Review' : 'Strategic Insights'}
                    </h3>
