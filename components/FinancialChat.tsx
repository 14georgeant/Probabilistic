...
const FinancialChat: React.FC<FinancialChatProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-y-0 right-0 w-full md:w-[500px] bg-gray-900 shadow-2xl border-l border-emerald-500/50 transform transition-transform duration-300 z-50 flex flex-col animate-fade-in">
            {/* Header */}
            <div className="bg-emerald-900/80 backdrop-blur-md p-4 border-b border-emerald-700 flex justify-between items-center">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-lg">
                        <svg className="w-6 h-6 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    </div>
                    <div>
                        <h3 className="font-bold text-white">ICT Financial Analyst</h3>
                ...
                <button onClick={onClose} className="text-emerald-300 hover:text-white p-2">
