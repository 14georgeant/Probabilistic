...
const ProgrammerChat: React.FC<ProgrammerChatProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-y-0 right-0 w-full md:w-[600px] bg-gray-900 shadow-2xl border-l border-lime-500/50 transform transition-transform duration-300 z-50 flex flex-col animate-fade-in">
            {/* Header */}
            <div className="bg-lime-900/80 backdrop-blur-md p-4 border-b border-lime-700 flex justify-between items-center">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gray-900 flex items-center justify-center shadow-lg border border-lime-500">
                        <span className="text-2xl">👨‍💻</span>
                    </div>
                    <div>
                        <h3 className="font-bold text-white">Programmer's Mate</h3>
                        <span className="text-[10px] text-lime-300 flex items-center gap-1">
                ...
                <button onClick={onClose} className="text-lime-300 hover:text-white p-2">
